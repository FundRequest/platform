...
public class RequestControllerTest {
    ...
    public void findAll() throws Exception {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.get("/api/requests").accept(MediaType.APPLICATION_JSON))
    ...
    public void findById() throws Exception {
        ...
        this.mockMvc.perform(RestDocumentationRequestBuilders.get("/api/requests/{id}", request.getId()).accept(MediaType.APPLICATION_JSON))
                    .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public void createRequest() throws Exception {
        ...
        this.mockMvc.perform(
                RestDocumentationRequestBuilders.post("/api/requests").contentType(MediaType.APPLICATION_JSON).content(
    ...
    public void addWatcher() throws Exception {
        ...
        this.mockMvc.perform(
                RestDocumentationRequestBuilders.post("/api/requests/123/watchers").contentType(MediaType.APPLICATION_JSON)
                                                .principal(principal))
                    .andExpect(
                            MockMvcResultMatchers.status().isCreated())
    ...
    public void removeWatcher() throws Exception {
        ...
        this.mockMvc.perform(
                RestDocumentationRequestBuilders.delete("/api/requests/123/watchers").contentType(MediaType.APPLICATION_JSON)
                                                .principal(principal))
                    .andExpect(
