...
operation::requests-can-claim-example[snippets='request-fields,curl-request,http-response']
...
operation::requests-claim-example[snippets='request-fields,curl-request,http-response']
