...
class OpenRequestsNotificationsControllerTest extends AbstractControllerTest<OpenRequestsNotificationsController> {
    ...
    void showGeneratedTemplate_allFilledIn() throws Exception {
        ...
        when(requestService.findAllProjects()).thenReturn(projects);
        when(requestService.findAllTechnologies()).thenReturn(technologies);
        when(notificationsTemplateService.generateOpenRequestsMailTemplateFor(selectedProjects, selectedTechnologies, Long.valueOf(lastUpdatedSinceDays))).thenReturn(template);
    ...
    void showGeneratedTemplate_noLastUpdatedSinceDays() throws Exception {
        ...
        when(requestService.findAllProjects()).thenReturn(projects);
        when(requestService.findAllTechnologies()).thenReturn(technologies);
        when(notificationsTemplateService.generateOpenRequestsMailTemplateFor(selectedProjects, selectedTechnologies, 0L)).thenReturn(template);
    ...
    void showGeneratedTemplate_noProjects() throws Exception {
        ...
        when(requestService.findAllProjects()).thenReturn(projects);
        when(requestService.findAllTechnologies()).thenReturn(technologies);
        when(notificationsTemplateService.generateOpenRequestsMailTemplateFor(new ArrayList<>(), selectedTechnologies, Long.valueOf(lastUpdatedSinceDays))).thenReturn(template);
    ...
    void showGeneratedTemplate_noTechnologies() throws Exception {
        ...
        when(requestService.findAllProjects()).thenReturn(projects);
        when(requestService.findAllTechnologies()).thenReturn(technologies);
        when(notificationsTemplateService.generateOpenRequestsMailTemplateFor(selectedProjects, new ArrayList<>(), Long.valueOf(lastUpdatedSinceDays))).thenReturn(template);
    ...
    void showGeneratedTemplate_nothingFilledIn() throws Exception {
        ...
        when(requestService.findAllProjects()).thenReturn(projects);
        when(requestService.findAllTechnologies()).thenReturn(technologies);
        when(notificationsTemplateService.generateOpenRequestsMailTemplateFor(new ArrayList<>(), new ArrayList<>(), 0L)).thenReturn(template);
