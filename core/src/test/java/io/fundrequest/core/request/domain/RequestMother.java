...
public final class RequestMother {
    ...
    public static RequestBuilder freeCodeCampNoUserStories() {
        return RequestBuilder.aRequest()
                             .withIssueInformation(IssueInformationMother.kazuki43zooApiStub().build())
    ...
    public static RequestBuilder fundRequestArea51() {
        final Set<RequestTechnology> technologies = new HashSet<>();
        ...
        return RequestBuilder.aRequest()
                             .withIssueInformation(IssueInformationMother.fundRequestArea51().build())
