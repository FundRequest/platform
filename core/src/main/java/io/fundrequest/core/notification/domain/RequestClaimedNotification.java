...
public class RequestClaimedNotification extends Notification {
    ...
    public RequestClaimedNotification(NotificationType type, LocalDateTime date, Long blockchainEventId, Long requestId, String solver) {
        super(type, date, blockchainEventId);
