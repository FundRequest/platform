package io.fundrequest.platform.profile.profile.infrastructure;

import com.fasterxml.jackson.databind.DeserializationFeature;
import com.fasterxml.jackson.databind.ObjectMapper;
import io.fundrequest.core.keycloak.KeycloakRepository;
import io.fundrequest.core.keycloak.Provider;
import io.fundrequest.platform.profile.profile.dto.accesstoken.LinkedInTokenResult;
...
@Component
public class ProfileKeycloakRepository extends KeycloakRepository {

    private RealmResource resource;
    private String keycloakUrl;
    private final ObjectMapper objectMapper;

    public ProfileKeycloakRepository(RealmResource resource, @Value("${io.fundrequest.keycloak-custom.server-url}") String keycloakUrl) {
        super(resource);
